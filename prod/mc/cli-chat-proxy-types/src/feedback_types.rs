...
//!
//! These types support the feedback collection system for Xvora sessions.
//! The agent (xai-xvora-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using Xvora productively! Would you mind sharing quick feedback?".to_string()
}
