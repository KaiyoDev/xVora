...
/// `filename`, `path`, `metadata`) that the xvora SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the xvora SLOP converter to
    ...
    /// - `path`: file path on the xvora Computer filesystem
