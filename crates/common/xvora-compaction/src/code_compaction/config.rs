//! xvora-build compaction configuration.
//!
...
/// xvora-build and xvora chat (~85% trigger on both sides).
pub const DEFAULT_AUTO_COMPACT_THRESHOLD_PERCENT: u8 = 85;

/// Minimum character count for a cleaned summary seed.
///
/// xvora-build retries when the cleaned summary is shorter than this — the
