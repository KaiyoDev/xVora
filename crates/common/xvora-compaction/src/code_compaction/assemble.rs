//! Compacted-history assembly (xvora's rebuild structure, generic).
//!
...
//! ```
//!
//! xvora is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // xvora keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn xvora_order_recent_before_summary() {
