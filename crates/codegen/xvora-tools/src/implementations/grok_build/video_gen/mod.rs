...
const XAI_VIDEO_MODEL: &str = "xvora-imagine-video-1.5";
...
const DEFAULT_ZDR_VIDEO_KEY_PREFIX: &str = "xvora-videos/";
...
/// the deliberate `/imagine-video` slash command shows the paid subscription
/// modal instead.
