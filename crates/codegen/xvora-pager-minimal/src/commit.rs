...
use xvora_pager::scrollback::blocks::ToolCallBlock;
use xvora_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use xvora_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                xvora_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
