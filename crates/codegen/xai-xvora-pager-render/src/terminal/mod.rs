...
impl TerminalContext {
    ...
    pub fn telemetry_snapshot(&self) -> xai_xvora_telemetry::events::TerminalTelemetry {
        ...
        xai_xvora_telemetry::events::TerminalTelemetry {
            ...
            clipboard_native_tool: xai_xvora_shared::clipboard::native_tool_name().to_owned(),
            clipboard_data_control: crate::clipboard::wayland_data_control_label().to_owned(),
        }
    }

    /// Extract terminal info for feedback submissions.
    pub fn feedback_info(&self) -> xai_xvora_shared::session::FeedbackTerminalInfo {
        use xai_xvora_shared::session::FeedbackTerminalInfo;
        ...
        FeedbackTerminalInfo {
            ...
            clipboard_native_tool: Some(xai_xvora_shared::clipboard::native_tool_name().to_owned()),
...
/// `xai-xvora-pager-pty-harness/src/pty.rs` (test-env hygiene — the PTY
