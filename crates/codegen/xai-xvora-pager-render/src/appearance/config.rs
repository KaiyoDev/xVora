...
pub struct AnimationConfig {
    ...
    /// Also enabled by the `XVORA_FPS=1` env var. Default: false.
    pub show_fps: bool,
}
...
pub struct RawAnimationConfig {
    ...
    /// Requires a debug build. Also enabled by XVORA_FPS=1 env var. Default: false.
    pub show_fps: bool,
}
...
pub fn persist_respect_manual_folds(enabled: bool) -> std::io::Result<()> {
    ...
    if xai_xvora_config::user_xvora_home().is_none() {
