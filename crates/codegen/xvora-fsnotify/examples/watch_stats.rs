...
//! XVORA_FSNOTIFY_PER_DIR=0 cargo run --release -p fsnotify --example watch_stats -- run /tmp/js-repo 5
//! XVORA_FSNOTIFY_PER_DIR=1 cargo run --release -p fsnotify --example watch_stats -- run /tmp/js-repo 5
//! ```
//!
