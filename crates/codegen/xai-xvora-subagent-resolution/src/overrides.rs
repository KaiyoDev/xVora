...
//!
//! Extracted from `xai-xvora-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use serde::de::DeserializeOwned;
use xai_xvora_tools::implementations::xvora::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use xai_xvora_tools::implementations::xvora::task::types::ModelOverrideProvenance;
