...
//!
//! Extracted from `xvora-shell/src/agent/subagent/` `resolve_effective_overrides()`.
...
use xvora_tools::implementations::xvora::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use xvora_tools::implementations::xvora::task::types::ModelOverrideProvenance;
