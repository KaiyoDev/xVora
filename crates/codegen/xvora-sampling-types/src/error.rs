//! TODO: Move from xvora-shell/src/sampling/error.rs
...
mod tests {
    ...
    // The canonical wording table lives beside the detector in xvora-compaction; tests here pin only crate-local couplings
    #[test]
