...
// engine in `crates/common/xvora-compaction` operate over xvora's
...
/// ([stream/messages.rs:340](crates/codegen/xvora-sampler/src/stream/messages.rs))
...
///
/// This is `pub` so downstream crates (`xvora-shell`) can re-use it
...
impl From<ChatResponseMessage> for ConversationItem {
    fn from(msg: ChatResponseMessage) -> Self {
        ...
        // ([crates/codegen/xvora-sampler/src/stream/chat_completions.rs])
...
/// ([crates/codegen/xvora-sampler/src/stream/messages.rs]) instead
