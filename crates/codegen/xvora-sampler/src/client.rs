...
use xvora_sampling_types::error::{parse_error_bytes, try_parse_stream_error};
...
impl SamplingClient {
    ...
    pub async fn conversation_stream_responses(
        ...
        let extra_tools = xvora_sampling_types::extra_raw_tools(&request.hosted_tools);
...
mod tests {
    ...
    fn new_applies_extra_headers() {
        ...
        cfg.extra_headers
            .insert("x-XAI-token-auth".to_string(), "xvora-cli".to_string());
