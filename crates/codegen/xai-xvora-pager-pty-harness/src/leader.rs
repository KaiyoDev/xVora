...
//! elected leader) plus a fixed leader socket beneath its `XVORA_HOME`; clients
...
impl LeaderCluster {
    ...
    /// The cluster's sessions root: `XVORA_HOME/sessions` (layout below is
