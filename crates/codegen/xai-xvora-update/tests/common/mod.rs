...
/// binary. Once initialized, `xai_xvora_config::xvora_home()` will resolve to
...
/// Minimal [`xai_xvora_update::UpdateConfig`] for install tests.
pub fn make_update_config(channel: &str) -> xai_xvora_update::UpdateConfig {
    xai_xvora_update::UpdateConfig {
