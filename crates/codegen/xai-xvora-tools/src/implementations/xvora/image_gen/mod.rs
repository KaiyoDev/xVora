...
pub use xai_xvora_tools_api::slash_commands::{
...
pub(crate) const TIER_RESTRICTED_UPSELL: &str = "Image generation is a SuperGrok feature and isn't available on the free or X Basic tier. Let the user know they can unlock image and video generation by upgrading to SuperGrok: https://grok.com/supergrok?referrer=xvora. Do not retry this tool.";
    ...
    async fn tier_restricted_short_circuits_with_upsell() {
        ...
        match result {
            ToolOutput::Text(t) => {
                ...
                assert!(t.text.contains("supergrok?referrer=xvora"));
            }
