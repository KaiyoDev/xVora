...
use crate::implementations::xvora_hashline::read_file::format_hashline_content;
use crate::implementations::xvora_hashline::scheme::{
...
mod tests {
    ...
    use crate::implementations::xvora_hashline::config::HashlineSchemeParams;
    use crate::implementations::xvora_hashline::scheme::{ChunkFingerprint, ContentOnly};
