...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::xvora_hashline::anchor::split_lines;
        use crate::implementations::xvora_hashline::edit::apply::anchor_suffix;
        use crate::implementations::xvora_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    fn test_scheme() -> Box<dyn crate::implementations::xvora_hashline::scheme::AnchorScheme> {
        crate::implementations::xvora_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
