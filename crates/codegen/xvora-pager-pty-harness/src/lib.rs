//! Unified PTY harness for xvora-pager.
//!
...
//!    `xvora-pager/tests/scenarios/`) — assert screen contents and
...
impl PtyHarness {
    ...
    /// # use xvora_pager_pty_harness::{PtyHarness, ContentController, pager_binary};
