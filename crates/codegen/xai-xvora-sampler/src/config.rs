...
//! `xai_xvora_sampling_types::SamplingConfig` so that the sampler crate
...
/// submit.
///
/// # Construction in `xai-xvora-shell`
///
...
/// composing chat-state's `xai_xvora_sampling_types::SamplingConfig`
