...
use xai_xvora_tools::types::output::ToolRunResult;
use xai_xvora_workspace_client::{WorkspaceClient, is_transport_fatal};
pub use xai_xvora_workspace_types::rpc::WorkspaceRpc;
pub use xai_xvora_workspace_types::rpc::agents_md::DiscoverAgentsMdReq;
pub use xai_xvora_workspace_types::rpc::code_nav::{
...
pub use xai_xvora_workspace_types::rpc::fs::{
...
pub use xai_xvora_workspace_types::rpc::git::{
...
pub use xai_xvora_workspace_types::rpc::hooks::{
    HookEventNameWire, HookRegistryReq, HookRegistryWire, HookSpecWire,
};
pub use xai_xvora_workspace_types::rpc::hunks::{
...
pub use xai_xvora_workspace_types::rpc::search::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
pub use xai_xvora_workspace_types::rpc::session::{BeginPromptReq, EndPromptReq, RewindToReq};
pub use xai_xvora_workspace_types::rpc::skills::DiscoverSkillsReq;
pub use xai_xvora_workspace_types::rpc::workspace::WorkspaceInfoReq;
pub use xai_xvora_workspace_types::rpc::worktree::{
...
fn hook_registry_to_wire(
    registry: &xai_xvora_hooks::discovery::HookRegistry,
...
) -> WorkspaceResult<xai_xvora_hooks::discovery::HookRegistry> {
...
///   session's [`FinalizedToolset`](xai_xvora_tools::registry::types::FinalizedToolset).
...
impl WorkspaceOps {
    ...
    pub async fn hook_registry(&self) -> WorkspaceResult<xai_xvora_hooks::discovery::HookRegistry> {
    ...
    ///   [`FinalizedToolset`](xai_xvora_tools::registry::types::FinalizedToolset)
...
mod tests {
    ...
    /// request types are defined in `xai-xvora-workspace-types` (and re-exported
    ...
    async fn end_local_session_drops_bound_toolset() {
        ...
        let toolset = std::sync::Arc::new(
            xai_xvora_tools::registry::types::FinalizedToolset::empty_for_test(),
        );
    ...
    fn hook_registry_wire_round_trip_both_directions() {
        let spec = xai_xvora_hooks::config::HookSpec {
            ...
            event: xai_xvora_hooks::event::HookEventName::PreToolUse,
            ...
            url_raw: None,
            timeout_ms: 5000,
            source_dir: std::path::PathBuf::from("/home/u/.xvora/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
        };
        let mut registry = xai_xvora_hooks::discovery::HookRegistry::default();
    ...
    fn hook_event_name_wire_covers_all_upstream_variants() {
        use xai_xvora_hooks::event::HookEventName as E;
    ...
    /// can't depend on `xai-xvora-hooks`, and `hook_registry_to_wire` only couples
    ...
    fn hook_spec_wire_covers_all_upstream_fields() {
        use xai_xvora_hooks::config::HookSpec;
