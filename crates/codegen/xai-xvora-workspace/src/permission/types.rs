...
pub enum ClientType {
    ...
    ///
    /// Accepts both the hyphenated `"xvora-pager"` (what the pager actually
...
impl ClientType {
    /// Product token for the `User-Agent` header (e.g. `xvora-pager`).
...
impl From<&xai_xvora_tools::types::ToolInput> for AccessKind {
    fn from(input: &xai_xvora_tools::types::ToolInput) -> Self {
...
pub enum RequirementSource {
    Unknown,
    /// User-writable `~/.xvora/requirements.toml` — untrusted for keeping a
...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use xai_xvora_tools::implementations::xvora_hashline::edit::types::HashlineEditInput;
        use xai_xvora_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use xai_xvora_tools::implementations::xvora::bash::BashToolInput;
        use xai_xvora_tools::types::ToolInput;
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use xai_xvora_tools::implementations::use_tool::UseToolInput;
        use xai_xvora_tools::types::ToolInput;
    ...
    fn monitor_maps_to_bash_access() {
        use xai_xvora_tools::implementations::xvora::monitor::types::MonitorInput;
        use xai_xvora_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use xai_xvora_tools::implementations::xvora::web_fetch::WebFetchInput;
        use xai_xvora_tools::types::ToolInput;
    ...
    fn web_search_maps_to_web_search_access() {
        use xai_xvora_tools::implementations::xvora::web_search::WebSearchInput;
        use xai_xvora_tools::types::ToolInput;
