//! AcpFsAdapter: implements `xai-xvora-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates xai-xvora-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use xai_xvora_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps xai-xvora-shell's ACP gateway to satisfy xai-xvora-tools' AsyncFileSystem.
///
