...
use xai_xvora_pager::appearance::AppearanceConfig;
use xai_xvora_pager::minimal_api;
use xai_xvora_pager::render::Renderable;
use xai_xvora_pager::scrollback::block::RenderBlock;
use xai_xvora_pager::scrollback::blocks::ToolCallBlock;
use xai_xvora_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use xai_xvora_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                xai_xvora_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
    ...
    fn committed_edit_keeps_diff_line_backgrounds() {
        ...
        use ratatui::layout::Rect;
        use similar::ChangeTag;
        use xai_xvora_pager::diff::DiffLine;
