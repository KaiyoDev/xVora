...
use xai_xvora_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (xai_xvora_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    xai_xvora_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use xai_xvora_shell::tools::{TodoItem, TodoPriority};
