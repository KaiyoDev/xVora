...
//! OS-level sandboxing for Xvora via [nono](https://crates.io/crates/nono).
//!
...
//!
//! ```rust,no_run
//! use xai_xvora_sandbox::{SandboxManager, ProfileName};
//! use std::path::Path;
//!
...
const BWRAP_ENV_VAR: &str = "__XVORA_INSIDE_BWRAP";
