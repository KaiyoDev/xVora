    ...
    let cases = vec![
        ...
        Case {
            ...
            payload: HookPayload::StopFailure {
                error: xvora_hooks::event::StopFailureKind::RateLimit,
        ...
        Case {
            ...
            payload: HookPayload::StopCancelled {
                reason: xvora_hooks::event::StopCancelledReason::UserInterrupt,
                cancelled_by: xvora_hooks::event::CancelledBy::User,
