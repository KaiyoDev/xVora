...
) -> Option<xai_xvora_sampling_types::PriorTurnInterrupt> {
    use xai_xvora_sampling_types::PriorTurnInterrupt;
    match category {
...
/// committing it would silently run xvora flavor. Distinct from
