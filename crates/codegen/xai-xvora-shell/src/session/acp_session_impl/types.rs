...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<xai_xvora_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(xai_xvora_tools::implementations::xvora::update_goal::UpdateGoalInput),
    Channel(xai_xvora_tools::implementations::xvora::update_goal::UpdateGoalEnvelope),
}
