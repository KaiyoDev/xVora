...
//! window containing a [`xai_xvora_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`xai_xvora_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`xai_xvora_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`xai_xvora_mcp::servers::ClientStateKind::Empty`]
...
use xai_xvora_mcp::servers::{McpClientEventKind, McpServerName};
