...
///
/// [`SubagentRuntimeOverrides::harness_agent_type`]: xai_xvora_tools::implementations::xvora::task::types::SubagentRuntimeOverrides::harness_agent_type
...
pub(crate) struct RoleSpawnOverride {
    ...
    /// Resolved harness `agent_type` (e.g. `"xvora-plan"`)
...
mod tests {
    ...
    fn planner_template_default_render_preserves_wording_and_has_no_placeholders() {
        ...
        // (xvora) tool names; guards against accidental wording drift.
