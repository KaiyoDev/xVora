//! AcpTerminalAdapter: implements `xai-xvora-tools::TerminalBackend` using ACP gateway calls.
//!
//! This adapter enables bash tool execution over ACP (remote execution).
//! It translates xai-xvora-tools' `TerminalBackend` trait into ACP protocol calls:
...
use xai_xvora_tools::computer::types::{
...
/// Wraps xai-xvora-shell's ACP gateway to satisfy xai-xvora-tools' TerminalBackend.
