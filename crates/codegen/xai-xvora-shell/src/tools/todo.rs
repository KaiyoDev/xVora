//! Todo types — re-exported from `xai-xvora-tools` with ACP conversion helpers.
//!
//! Types are canonical in `xai-xvora-tools`. This module adds ACP ↔ TodoItem
//! conversions since `xai-xvora-tools` is protocol-agnostic.

pub use xai_xvora_tools::implementations::xvora::todo::TodoId;
pub use xai_xvora_tools::implementations::xvora::todo::TodoItem;
pub use xai_xvora_tools::implementations::xvora::todo::TodoPriority;
pub use xai_xvora_tools::implementations::xvora::todo::TodoState;
pub use xai_xvora_tools::implementations::xvora::todo::TodoStatus;
