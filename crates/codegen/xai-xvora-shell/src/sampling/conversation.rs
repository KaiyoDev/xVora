...
//!
//! The canonical types now live in `xai_xvora_sampling_types::conversation`.
//! This module re-exports them and adds xvora-shell-specific types
//! (`ConversationRequestTrace`) that depend on internal crate types.

// Re-export everything from the standalone crate.
pub use xai_xvora_sampling_types::conversation::*;

// ============================================================================
// xvora-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `xai-xvora-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in xai-xvora-sampling-types crate.
