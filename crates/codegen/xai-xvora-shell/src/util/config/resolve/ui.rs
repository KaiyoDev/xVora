...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "XVORA_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`XVORA_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "XVORA_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`XVORA_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "XVORA_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`XVORA_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `XVORA_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("XVORA_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes XVORA_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
