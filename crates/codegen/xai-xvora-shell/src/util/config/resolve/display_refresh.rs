...
use xai_xvora_config_types::DisplayRefreshSettings;

pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "XVORA_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "XVORA_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`XVORA_MIN_DRAW_MS` / `XVORA_SCROLL_CADENCE_MS`).
