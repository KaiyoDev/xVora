...
use xai_xvora_hooks::discovery::HookSource;
...
pub fn discover_hook_source_paths(
    ...
    // sources. Native .xvora/hooks/ directories are still scanned (they hold
    ...
    // user_xvora_home() is None when no home resolves, so inspect lists the same
...
pub fn discover_hooks(
    ...
    xai_xvora_hooks::discovery::HookRegistry,
    Vec<xai_xvora_hooks::error::HookError>,
) {
