...
use xai_xvora_tools::implementations::xvora::task::types::{SubagentRequest, SubagentResult};
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        sampling_config: xai_xvora_sampler::SamplerConfig {
            api_key: None,
            base_url: String::new(),
            model: String::new(),
        ...
        fs: Arc::new(xai_xvora_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: xai_xvora_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: xai_xvora_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: xai_xvora_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl xai_xvora_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &xai_xvora_tools::implementations::lsp::LspToolInput,
    ) -> xai_xvora_tools::implementations::lsp::LspToolResult {
        xai_xvora_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<xai_xvora_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<xai_xvora_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
