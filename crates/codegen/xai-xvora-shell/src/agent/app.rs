    ...
    W: tokio::io::AsyncWrite + Unpin + Send + 'static,
{
    ...
    let workspace_user_dir = xai_xvora_agent::prompt::workspace_user::optional_workspace_user_dir();
...
pub async fn run_stdio_agent(
    ...
    xai_xvora_telemetry::unified_log::set_version(xai_xvora_version::VERSION);
...
pub async fn run_leader(
    ...
    local_set
        .run_until(async move {
            ...
            let initial_auth_key_hash = xai_xvora_config::user_xvora_home()
