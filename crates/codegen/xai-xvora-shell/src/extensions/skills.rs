...
use xai_xvora_agent::prompt::skills::{
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "x.ai/skills/add" => {
            ...
            .await
            {
                xai_xvora_telemetry::session_ctx::log_event(
                    xai_xvora_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            xai_xvora_telemetry::session_ctx::log_event(xai_xvora_telemetry::events::SkillAdded {
        ...
        "x.ai/skills/remove" => {
            ...
            {
                xai_xvora_telemetry::session_ctx::log_event(
                    xai_xvora_telemetry::events::SkillRemoved { success: false },
                );
            ...
            xai_xvora_telemetry::session_ctx::log_event(xai_xvora_telemetry::events::SkillRemoved {
                success: true,
            });
