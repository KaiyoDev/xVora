...
use xai_xvora_agent::plugins::git_install::{self, UpdateStatus};
use xai_xvora_agent::plugins::install_registry::{
    InstallError, InstallKind, InstallRegistry, InstalledRepo, MarketplaceProvenance,
};
use xai_xvora_plugin_marketplace::git::{self, SourceCacheLease};
use xai_xvora_plugin_marketplace::{
...
fn marketplace_root_for_provenance(
    provenance: &xai_xvora_agent::plugins::install_registry::MarketplaceProvenance,
...
fn filter_sources_by_allowlist(
    ...
    allowlist: &xai_xvora_workspace::permission::resolution::MarketplaceAllowlist,
...
mod tests {
    ...
    fn marketplace_allowlist(
        urls: &[&str],
    ) -> xai_xvora_workspace::permission::resolution::MarketplaceAllowlist {
        xai_xvora_workspace::permission::resolution::MarketplaceAllowlist {
    ...
    fn filter_sources_by_allowlist_unrestricted_passes_everything() {
        let allowlist = xai_xvora_workspace::permission::resolution::MarketplaceAllowlist::default();
        let sources = vec![
