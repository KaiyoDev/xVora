...
use xai_xvora_workspace::WorkspaceHandle;
...
async fn handle_workspace_start(
    ...
    let upload_queue_enabled =
        std::env::var("XVORA_WORKSPACE_UPLOAD_QUEUE_ENABLED").as_deref() != Ok("false");
    ...
    let handle = xai_xvora_workspace::connect_local_workspace(
        cwd_path.clone(),
        url,
        auth,
        Some(metadata),
...
pub async fn run_leader_server(
    ...
    loop {
        tokio::select! {
            ...
            xai_xvora_telemetry::unified_log::info("leader.client.registered", None,
            ...
            xai_xvora_telemetry::unified_log::info("leader.client.disconnected", None,
            ...
            xai_xvora_telemetry::unified_log::warn("leader.response.orphaned", None,
            ...
            xai_xvora_telemetry::unified_log::warn("leader.response.send_failed", None,
