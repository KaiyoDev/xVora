...
async fn offline_team_switch_purges_sidecar_and_permits_new_team() {
    ...
    assert!(
        xai_xvora_shell::config::managed_policy_compromised_for(&team_identity("team-b")),
    ...
    assert!(
        xai_xvora_shell::config::is_managed_config_hard_stale_for(&team_identity("team-b")),
