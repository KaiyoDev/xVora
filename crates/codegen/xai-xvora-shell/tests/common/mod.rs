//! Shared helpers for xai-xvora-shell integration tests.

use xai_xvora_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `xai_xvora_sampler::SamplingClient`, which takes a
