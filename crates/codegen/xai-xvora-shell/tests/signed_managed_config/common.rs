...
//! binary shares one process-global `XVORA_HOME`, process env, and key override.
...
pub fn signed_team_body(
    ...
    let payload = SignedPayload {
        ...
        fail_closed: requirements.is_some_and(xai_xvora_config::fail_closed_flag_from_str),
...
pub fn team_identity(id: &str) -> xai_xvora_shell::config::ServingIdentity {
    xai_xvora_shell::config::ServingIdentity::Team(id.to_owned())
}
