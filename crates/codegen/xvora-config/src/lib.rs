...
//! 4. `$XVORA_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
...
pub use paths::{
    ...
    default_xvora_home, encode_cwd_dirname, ensure_sessions_cwd_dir, grok_application, xvora_home,
