...
/// Tilde-collapse with a path-component prefix, so `HOME=/Users/u` does not match `/Users/user/xvora`.
...
mod tests {
    ...
    fn collapse_home_requires_whole_path_component() {
        ...
        assert_eq!(
            collapse_home_path(Path::new("/Users/u/xvora"), Some(home)),
            "~/xvora"
        );
        assert_eq!(
    ...
    fn update_from_notification_ors_cached_label_into_is_worktree() {
        let dir = PathBuf::from("/nonexistent-xvora-notif-label-wt");
        {
