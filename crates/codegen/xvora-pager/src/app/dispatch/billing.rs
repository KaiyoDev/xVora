...
pub(crate) fn acp_error_is_free_usage_exhausted(err: &agent_client_protocol::Error) -> bool {
    err.data
        .as_ref()
        .and_then(xvora_shell::sampling::error::error_detail_from_data)
        .as_deref()
...
pub(super) fn open_credit_limit_upsell(
    ...
    let (
        ...
        xvora_telemetry::events::CreditLimitChoice,
        bool,
    ) = match mode {
        ...
        CreditLimitUpsellMode::LegacyPayg { enabled: true } => (
            ...
            xvora_telemetry::events::CreditLimitChoice::PayAsYouGo,
            true,
        ),
    ...
    if max_tier {
        ...
        log_event(xvora_telemetry::events::CreditLimitUpsellShown {
            surface: xvora_telemetry::events::CreditLimitUpsellSurface::InlineCard,
            max_tier: true,
