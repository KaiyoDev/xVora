...
use super::settings::setters::{
    ...
    set_contextual_hint_send_now, set_contextual_hint_small_screen,
    set_contextual_hint_ssh_wrap, set_contextual_hint_undo, set_contextual_hint_word_select,
    set_default_model, set_default_selected_permission,
    ...
    set_show_thinking_blocks, set_show_tips, set_simple_mode, set_language, set_theme,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::OpenBlockViewer => {
            ...
            let mut credit_card: Option<(String, xvora_telemetry::events::CreditLimitChoice)> =
                None;
            with_scrollback(app, |s| {
            ...
            if let Some((url, choice)) = credit_card {
                log_event(xvora_telemetry::events::CreditLimitUpsellClicked {
        ...
        Action::SetLanguage(v) => set_language(app, v),
