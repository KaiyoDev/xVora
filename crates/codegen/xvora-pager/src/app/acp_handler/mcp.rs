...
/// `xvora-shell/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`xvora_shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`xvora_shell::extensions::mcp::McpServerStatusPayload`] +
/// [`xvora_shell::extensions::mcp::McpServerStatus`]) instead of
...
/// on config reload (`crates/codegen/xvora-shell/src/agent/mvp_agent.rs`
