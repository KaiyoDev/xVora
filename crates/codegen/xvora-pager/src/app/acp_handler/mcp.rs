...
///
/// Routing rules, verified against the four shell emit sites in `xvora-shell/src/session/acp_session.rs`
...
/// (See `notify_servers_updated` in `crates/codegen/xvora-shell/src/agent/mvp_agent.rs`.)
