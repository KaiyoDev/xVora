...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    xvora_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        xvora_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        xvora_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        xvora_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        xvora_shell::session::PromptOrigin::TaskCompleted { .. }
            | xvora_shell::session::PromptOrigin::SubagentCompleted { .. }
            | xvora_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | xvora_shell::session::PromptOrigin::ParentAgentMessage { .. }
            | xvora_shell::session::PromptOrigin::NotificationDrain
    )
}
