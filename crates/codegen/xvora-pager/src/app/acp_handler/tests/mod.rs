...
pub(super) fn xvora_model_switch_notif(
    session_id: &str,
    event_id: &str,
) -> acp::ExtNotification {
...
pub(super) fn xvora_unhandled_notif(
    session_id: &str,
    event_id: &str,
) -> acp::ExtNotification {
    let payload = SessionNotification {
...
pub(super) fn xvora_turn_completed_notif(
    session_id: &str,
    prompt_id: &str,
    stop_reason: &str,
    is_replay: bool,
...
pub(super) fn xvora_turn_completed_replay(
    session_id: &str,
    prompt_id: &str,
    stop_reason: &str,
...
/// Callers pass an `agent_result` with no canonical truncation text.
/// A rail test therefore fails if its typed-kind read is deleted; the text fallback cannot mask it.
pub(super) fn xvora_turn_completed_failed_with_error_kind(
    session_id: &str,
    prompt_id: &str,
    agent_result: &str,
    error_kind: &str,
...
pub(super) fn xvora_turn_completed_notif_with_cancel_trigger(
    session_id: &str,
    prompt_id: &str,
    stop_reason: &str,
    cancel_trigger: &str,
...
pub(super) fn xvora_wake_turn_completed_notif(
    session_id: &str,
    prompt_id: &str,
...
pub(super) fn xvora_hook_execution_notif_for_prompt(
    session_id: &str,
    event_name: &str,
...
pub(super) fn xvora_hook_execution_notif_with_runs(
    session_id: &str,
    event_name: &str,
    prompt_id: Option<&str>,
    is_replay: bool,
...
pub(super) fn xvora_hook_execution_notif(
    session_id: &str,
    event_name: &str,
    is_replay: bool,
) -> acp::ExtNotification {
    xvora_hook_execution_notif_for_prompt(session_id, event_name, None, is_replay)
}
