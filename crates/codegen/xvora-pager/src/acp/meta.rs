...
pub struct NotificationMeta {
    ...
    /// (`"{sessionId}-{counter}"`, see `xvora-shell util::event_id`). The
...
/// replayed notifications (`_meta.isReplay`, stamped by xvora-shell's
...
pub mod user_message_chunk_meta {
    ...
    /// ([`xvora_shell::session::PromptOrigin::hide_user_echo_from_scrollback`]).
