...
pub struct WelcomeRenderParams<'a> {
    ...
    pub foreign_resume_hint: Option<&'a xvora_workspace::foreign_sessions::RecentForeignSession>,
...
mod tests {
    ...
    fn foreign_resume_tip_names_each_tool_and_age() {
        use xvora_workspace::foreign_sessions::ForeignSessionTool;
        ...
        for (tool, label) in [
            ...
            let hint = xvora_workspace::foreign_sessions::RecentForeignSession {
                tool,
