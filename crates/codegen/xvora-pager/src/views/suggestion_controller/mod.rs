...
// (e.g. xvora-pager-minimal's) compiling when optional fields are added.
#[derive(Debug, Clone, Default)]
...
impl SuggestionController {
    pub fn new() -> Self {
        Self {
            ...
            tab_pending: None,
            enabled: xvora_config::env_bool("XVORA_SUGGESTIONS").unwrap_or(false),
            dropdown: CompletionDropdownState::default(),
            ai_enabled: xvora_config::env_bool("XVORA_SUGGESTIONS_AI").unwrap_or(false),
