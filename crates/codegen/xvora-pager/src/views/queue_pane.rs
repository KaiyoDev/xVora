...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. XvoraNight's dark band leaking into XvoraDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default XvoraNight, dark) after the user switches —
        // painting a dark band on a light XvoraDay canvas.
