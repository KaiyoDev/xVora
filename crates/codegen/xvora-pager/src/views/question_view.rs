...
pub use xvora_tools::implementations::xvora::ask_user_question::{
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> xvora_tools::implementations::xvora::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: xvora_tools::implementations::xvora::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
