//! Everything the `xvora-pager-minimal` crate reads and renders through.
//!
...
/// Instead the minimal draw loop renders a time-budgeted slice per frame (`xvora-pager-minimal::full_view::pump_transcript`).
