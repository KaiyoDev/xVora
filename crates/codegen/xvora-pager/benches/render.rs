//! Criterion benchmarks for the xvora-pager rendering pipeline.
//!
...
use xvora_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xvora_pager::scrollback::wrappers::EntryRenderer;
use xvora_pager::scrollback::{
