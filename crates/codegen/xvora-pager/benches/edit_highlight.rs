...
//!
//! ```text
//! cargo bench -p xvora-pager --bench edit_highlight
//! cargo bench -p xvora-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xvora_pager::scrollback::blocks::tool::{
...
use xvora_pager::syntax::{Syntect, get_syntect};
use xvora_pager::theme::Theme;
use xvora_pager_diff::{DiffHunk, DiffLine};
