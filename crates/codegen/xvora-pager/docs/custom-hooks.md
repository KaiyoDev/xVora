...
See the built-in examples in the `xvora-hooks` crate:

- [Safe Shell Guard](../../../xvora-hooks/examples/hooks/safe-shell.json)
- [No Recursive Grep](../../../xvora-hooks/examples/hooks/no-recursive-grep.json) — hard-blocks `grep -r`/`grep -R`/`rgrep` (OOM guard)
- [Session Audit Log](../../../xvora-hooks/examples/hooks/session-log.json)
- [Tool Activity Logger](../../../xvora-hooks/examples/hooks/tool-logger.json)
