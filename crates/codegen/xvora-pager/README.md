...
- [Hook Examples](../xvora-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`xvora-hooks`)](../xvora-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`xvora-plugin-marketplace`)](../xvora-plugin-marketplace/) — marketplace source loading, scanning, and install
