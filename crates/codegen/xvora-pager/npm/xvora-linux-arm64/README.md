# @kaiyodev/xvora-linux-arm64

Platform-specific binary for [`@kaiyodev/xvora`](https://www.npmjs.com/package/@kaiyodev/xvora) on linux-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @kaiyodev/xvora
```
