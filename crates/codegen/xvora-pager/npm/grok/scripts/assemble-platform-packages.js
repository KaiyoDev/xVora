...
// (`@xvora-official/grok`) lists all six as `optionalDependencies` pinned to
    ...
    const targets = [
        {
            ...
            defaultSource: path.join(xaiRoot, 'target', 'release', 'xvora-pager'),
        },
        {
            platform: 'darwin', arch: 'x64', binName: 'grok',
            envVar: 'GROK_DARWIN_X64',
            defaultSource: path.join(xaiRoot, 'target', 'x86_64-apple-darwin', 'release', 'xvora-pager'),
        },
        {
            ...
            defaultSource: path.join(xaiRoot, 'target',
                ...
                'x86_64-unknown-linux-gnu', 'release', 'xvora-pager'),
        },
        {
            ...
            defaultSource: path.join(xaiRoot, 'target',
                ...
                'aarch64-unknown-linux-gnu', 'release', 'xvora-pager'),
        },
        {
            platform: 'win32', arch: 'x64', binName: 'grok.exe',
            envVar: 'GROK_WIN32_X64',
            defaultSource: path.join(xaiRoot, 'target', 'x86_64-pc-windows-msvc', 'release', 'xvora-pager.exe'),
        },
        {
            platform: 'win32', arch: 'arm64', binName: 'grok.exe',
            envVar: 'GROK_WIN32_ARM64',
            defaultSource: path.join(xaiRoot, 'target', 'aarch64-pc-windows-msvc', 'release', 'xvora-pager.exe'),
        },
    ];
