...
impl HubHandle {
    ...
    pub(crate) async fn connect(
        ...
        let mut server_builder = ToolServerBuilder::default()
            ...
            .binary_version(xvora_version::VERSION)
...
impl ToolServerHandler for SessionRoutedToolHandler {
    ...
    async fn handle_call(&self, ctx: ToolCallContext, args: Value) -> ToolStream<TypedToolOutput> {
        ...
        Box::pin(async_stream::stream! {
            ...
            .set_outcome(file_utils::events::ToolOutcome::Success); yield
            ...
            .set_outcome(file_utils::events::ToolOutcome::Error); yield
...
mod tests {
    ...
    use xvora_tools::types::tool_metadata::ToolMetadata as XaiToolMetadata;
    #[derive(Debug)]
    ...
    fn task_completed_notif(task_id: &str) -> ToolNotification {
        use xvora_tools::computer::types::{TaskKind, TaskSnapshot};
