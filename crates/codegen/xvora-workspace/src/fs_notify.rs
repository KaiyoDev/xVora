...
/// Convert [`xvora_fsnotify::FsEventKind`] to the wire-type
/// [`xvora_workspace_types::FsEventKind`].
///
...
/// [`WorkspaceEvent::FsChanged`](xvora_workspace_types::WorkspaceEvent::FsChanged)
