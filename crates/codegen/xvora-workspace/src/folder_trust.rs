...
//!
//! How the consume side caches this verdict is a `xvora-shell` concern, documented there.
...
/// Kept local rather than in `xvora-version`: adding a symbol to that near-universal crate widens the rebuild/test fan-out for unrelated targets.
