...
/// Canonical definition lives in `xvora_workspace_types` (so both the
/// permission-validation layer and the MCP transport in `xvora-mcp` can
...
/// reached `xvora_workspace::permission::MCP_TOOL_NAME_DELIMITER`.
