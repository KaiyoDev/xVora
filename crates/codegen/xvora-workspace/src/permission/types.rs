...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use xvora_tools::implementations::xvora_hashline::edit::types::HashlineEditInput;
        use xvora_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use xvora_tools::implementations::xvora::bash::BashToolInput;
        use xvora_tools::types::ToolInput;
    ...
    fn monitor_maps_to_bash_access() {
        use xvora_tools::implementations::xvora::monitor::types::MonitorInput;
        use xvora_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use xvora_tools::implementations::xvora::web_fetch::WebFetchInput;
        use xvora_tools::types::ToolInput;
    ...
    fn web_search_maps_to_web_search_access() {
        use xvora_tools::implementations::xvora::web_search::WebSearchInput;
        use xvora_tools::types::ToolInput;
