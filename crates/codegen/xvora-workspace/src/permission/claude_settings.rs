...
// =============================================================================
//
// `xvora-shell::claude_import` writes the marker
...
pub fn is_claude_import_marked() -> bool {
    // Test escape hatch: shell tests call `refresh_marker_cache(true)`, which lives in xvora-shell (inaccessible from here at runtime)
