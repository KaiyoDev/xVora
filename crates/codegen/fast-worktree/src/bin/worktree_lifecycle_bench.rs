...
#[command(about = "Cross-transport xvora-fast-worktree/Grove lifecycle sampler")]
struct Cli {
...
fn cleanup_grove_identity(target: &CleanupTarget) -> Result<()> {
    ...
    let pin = format!("refs/xvora/worktrees/{}", target.worktree_id);
...
const HARNESS_INPUT_PATHS: &[&str] = &[
    "crates/codegen/xvora-fast-worktree/src/bin/worktree_lifecycle_bench.rs",
    "crates/codegen/xvora-fast-worktree/src/bin/worktree_lifecycle_bench/runtime.rs",
    "crates/codegen/xvora-fast-worktree/Cargo.toml",
    "crates/codegen/xvora-fast-worktree/BUILD.bazel",
    "Cargo.lock",
    "rust-toolchain.toml",
    ".bazelrc",
];
