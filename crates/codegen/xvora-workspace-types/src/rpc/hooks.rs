...
//! It is kept byte-identical to the upstream serde shape so this lean crate avoids the heavy `xvora_hooks` dep.
...
mod tests {
    ...
    /// Mirrors `event_name_deser_all_variants` in xvora-hooks; the two lists move together.
    #[test]
