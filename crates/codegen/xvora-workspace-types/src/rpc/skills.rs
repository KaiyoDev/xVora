...
//!
//! SYNC: [`SkillInfo`] / [`SkillScope`] mirror the serde shape the server serializes in `xvora-tools/src/implementations/skills/types.rs`.
...
mod tests {
    ...
    // Fixture mirrored field-for-field from the xvora-tools SkillInfo serialization
