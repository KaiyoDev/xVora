...
//! `xai_xvora_shell::session::git` and `xai_xvora_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `xai_xvora_shell::session::git::VcsKind`.
