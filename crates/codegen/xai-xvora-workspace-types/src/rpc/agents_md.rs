...
/// Claude.md / `.xvora/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.xvora` and compat dirs.
...
/// Mirrors the serde shape of `xai-xvora-agent`'s `AgentConfigFile`.
