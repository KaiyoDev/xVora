...
///
/// Delegates to [`xvora_shared::clipboard::mime_to_extension`].
...
///   [`xvora_shell::session::placeholder_images::load_placeholder_image`]
...
/// [`xvora_shell::session::placeholder_images::recover_orphan_placeholders_with_prefixes_and_caps`].
