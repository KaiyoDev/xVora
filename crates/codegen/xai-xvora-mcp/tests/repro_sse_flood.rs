...
//!
//! Run with: cargo test -p xai-xvora-mcp --test repro_sse_flood -- --nocapture
...
use xai_xvora_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use xai_xvora_mcp::rmcp::ServiceExt;
use xai_xvora_mcp::rmcp::transport::StreamableHttpClientTransport;
use xai_xvora_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
