...
use xai_xvora_pager::app::mermaid_worker::render_via_subprocess;
use xai_xvora_pager::scrollback::blocks::mermaid_content::MermaidRenderQuality;
...
fn tight_timeout_kills_child_and_returns_err() {
    ...
    // `xai_xvora_mermaid::subprocess` `reap_terminates_the_process` unit test;
