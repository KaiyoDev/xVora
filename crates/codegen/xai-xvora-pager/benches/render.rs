//! Criterion benchmarks for the xai-xvora-pager rendering pipeline.
//!
...
use xai_xvora_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xai_xvora_pager::scrollback::wrappers::EntryRenderer;
use xai_xvora_pager::scrollback::{
