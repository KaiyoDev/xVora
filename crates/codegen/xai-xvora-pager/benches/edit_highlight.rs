...
//!
//! ```text
//! cargo bench -p xai-xvora-pager --bench edit_highlight
//! cargo bench -p xai-xvora-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xai_xvora_pager::diff::{DiffHunk, DiffLine};
use xai_xvora_pager::scrollback::blocks::tool::{
...
use xai_xvora_pager::syntax::{Syntect, get_syntect};
