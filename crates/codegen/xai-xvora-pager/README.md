...
Terminal UI (TUI) for Xvora. Provides the interactive full-screen interface
...
- [Hook Examples](../xai-xvora-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`xai-xvora-hooks`)](../xai-xvora-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`xai-xvora-plugin-marketplace`)](../xai-xvora-plugin-marketplace/) — marketplace source loading, scanning, and install
