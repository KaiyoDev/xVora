...
//!
//! ```text
//! cargo run -p xai-xvora-pager --bin todo-pane-playground
//! ```
//!
...
use xai_xvora_pager::views::todo_pane::TodoPane;
use xai_xvora_shell::tools::{TodoItem, TodoPriority, TodoStatus};
