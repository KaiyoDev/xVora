...
const HERO_SUBTITLE: &str = "Thanks for trying xvora, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&xai_xvora_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        pinned.cta = Some(xai_xvora_announcements::AnnouncementCta {
        ...
        dismissible.cta = Some(xai_xvora_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/grok".into()),
            caption: Some("or use Ctrl+O".into()),
        });
