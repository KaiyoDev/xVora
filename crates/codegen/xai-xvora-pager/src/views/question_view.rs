...
use xai_xvora_markdown::StreamingMarkdownRenderer;
pub use xai_xvora_tools::implementations::xvora::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<xai_xvora_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: xai_xvora_telemetry::events::SuperGrokUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<xai_xvora_shell::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> xai_xvora_tools::implementations::xvora::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: xai_xvora_tools::implementations::xvora::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
