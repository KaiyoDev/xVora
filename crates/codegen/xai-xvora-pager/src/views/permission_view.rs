...
use xai_xvora_workspace::permission::bash_command_splitting::{
...
pub struct PermissionViewState {
    ...
    /// permissions). Imported from `xai-xvora-shell`, NOT duplicated locally.
...
mod tests {
    ...
    ///
    /// ```text
    /// PERMISSION_UI_RENDER_REVIEW=1 cargo test -p xai-xvora-pager --lib \
    ...
    fn historic_bash_fixture_path() -> std::path::PathBuf {
        // CARGO_MANIFEST_DIR = crates/codegen/xai-xvora-pager
