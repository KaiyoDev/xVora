...
pub struct AgentView {
    ...
    pub context_state: Option<xai_xvora_shell::session::ContextInfo>,
    ...
    pub(crate) deferred_session_mode: Option<xai_xvora_tools::types::SessionMode>,
    ...
    match kind {
        ...
        LocalQuestionKind::CreditLimitUpsell { choices } => {
            ...
            let choice = choices
                .get(*idx)
                .copied()
                .unwrap_or(xai_xvora_telemetry::events::CreditLimitChoice::PayAsYouGo);
            xai_xvora_telemetry::session_ctx::log_event(
                xai_xvora_telemetry::events::CreditLimitUpsellClicked {
        ...
        LocalQuestionKind::FreeUsageUpsell { source } => {
            ...
            xai_xvora_telemetry::session_ctx::log_event(
                xai_xvora_telemetry::events::SuperGrokUpsellClicked {
                    source,
                    auth_method: None,
                },
            );
...
fn translate_project_select(
    ...
    use xai_xvora_telemetry::events::{ProjectPickerOutcome, ProjectPickerSelected};
    let project_dir_options = resolved_paths.len().saturating_sub(1);
    let emit = |outcome: ProjectPickerOutcome| {
        xai_xvora_telemetry::session_ctx::log_event(ProjectPickerSelected {
            outcome,
...
fn remember_mode_enabled() -> bool {
    let path = xai_xvora_tools::util::xvora_home::xvora_home().join("config.toml");
...
fn question_visible_h(
    ...
    prompt_height: u16,
    question: &xai_xvora_tools::implementations::xvora::ask_user_question::Question,
    content_w: usize,
    preview: Option<&str>,
    fullscreen: bool,
    desc_cap: u16,
