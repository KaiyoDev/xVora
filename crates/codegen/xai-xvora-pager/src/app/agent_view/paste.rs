...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question =
            xai_xvora_tools::implementations::xvora::ask_user_question::Question {
                question: "Pick one?".to_string(),
                options: vec![
                xai_xvora_tools::implementations::xvora::ask_user_question::QuestionOption
