...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use xai_xvora_tools::implementations::xvora::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        xai_xvora_telemetry::session_ctx::log_event(xai_xvora_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            xai_xvora_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
