...
// minimal rendering lives in the sibling `xai-xvora-pager-minimal` crate; these
...
// `xai-xvora-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use xai_xvora_pager_render::{
