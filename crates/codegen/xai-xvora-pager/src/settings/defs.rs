...
//
// Concrete codes must match `xai_xvora_voice::STT_LANGUAGES` (official Grok STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        // The `XVORA_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // Catalog = official STT languages (see xai_xvora_voice::STT_LANGUAGES).
        SettingMeta {
