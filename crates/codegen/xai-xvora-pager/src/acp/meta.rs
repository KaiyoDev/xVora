...
//! xvora-shell hasn't been updated or meta is absent.
...
pub struct NotificationMeta {
    ...
    /// (`"{sessionId}-{counter}"`, see `xai-xvora-shell util::event_id`). The
...
/// replayed notifications (`_meta.isReplay`, stamped by xai-xvora-shell's
...
pub mod user_message_chunk_meta {
    ...
    /// ([`xai_xvora_shell::session::PromptOrigin::hide_user_echo_from_scrollback`]).
