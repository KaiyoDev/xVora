...
//!
//! ```text
//! cargo bench -p xvora-shell --bench skills_watcher_startup
//! # optional scale:
//! GROK_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p xvora-shell --bench skills_watcher_startup
//! ```
//!
...
fn build_fixture(worktree_dirs: usize) -> Fixture {
    ...
    let xvora_home = root.path().join("xvora-home");
