...
//!
//! The canonical types now live in `xvora_sampling_types::conversation`.
...
pub use xvora_sampling_types::conversation::*;
...
///
/// Stays in `xvora-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in xvora-sampling-types crate.
