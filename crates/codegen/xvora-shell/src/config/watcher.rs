...
/// processes (e.g. `xvora login` in another terminal).
///
...
impl SkillsFileWatcher {
    ...
    ///
    /// Uses [`collect_skill_config_dirs`](xvora_agent::prompt::skills::collect_skill_config_dirs)
    ...
    pub fn start(
        ...
        let xvora_home = xvora_tools::util::xvora_home::xvora_home();
