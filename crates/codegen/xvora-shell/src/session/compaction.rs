...
impl SessionActor {
    ...
    async fn run_compact_inner(
        ...
        self.dispatch_hook(
            ...
            xvora_hooks::event::HookPayload::PreCompact {
        ...
        let effective_tool_defs: Vec<xvora_sampling_types::ToolDefinition> = self
        ...
        if let Some(ref recovery_backend) = memory_backend_impl {
            ...
            if n > 0 {
                ...
                tracing::debug!(
                    target : xvora_telemetry::memory_log::TARGET, count = n,
        ...
        self.dispatch_hook(
            xvora_hooks::event::HookEventName::PostCompact,
            xvora_hooks::event::HookPayload::PostCompact {
                source: compact_source.into(),
            },
            None,
            None,
    ...
    fn persist_compaction_request_artifact(
        ...
        tools: Vec<xvora_sampling_types::ToolSpec>,
        user_context: Option<&str>,
...
mod inline_auto_compact_flow_tests {
    ...
    fn api_error_with_context_window(context_window: u64) -> xvora_sampler::SamplingErrorInfo {
