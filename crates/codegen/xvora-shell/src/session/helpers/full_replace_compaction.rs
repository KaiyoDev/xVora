...
//! (`xvora_compaction::code_compaction`).
//!
//! The shared engine drives the sample → retry → degenerate/failure
//! classification loop via [`sample_full_replace_summary`](xvora_compaction::sample_full_replace_summary);
...
//! [`FullReplaceError`](xvora_compaction::FullReplaceError).
