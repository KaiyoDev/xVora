...
//! window containing a [`xvora_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`xvora_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`xvora_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`xvora_mcp::servers::ClientStateKind::Empty`]
...
pub fn forward_status(gateway: &acp_lib::AcpAgentGatewaySender, payload: &McpServerStatusPayload) {
