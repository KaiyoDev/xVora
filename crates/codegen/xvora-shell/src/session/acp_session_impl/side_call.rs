...
impl From<&xvora_sampling_types::TokenUsage> for PromptCacheUsage {
    fn from(usage: &xvora_sampling_types::TokenUsage) -> Self {
...
pub(crate) struct AuxCall {
    ...
    pub(crate) hosted_tools: Vec<xvora_sampling_types::HostedTool>,
    pub(crate) model: String,
    /// Must match the main turn's, or the prompt differs before the conversation history even starts.
    pub(crate) reasoning_effort: Option<xvora_sampling_types::ReasoningEffort>,
...
impl SessionActor {
    ...
    pub(crate) fn parent_cached_request(&self, call: AuxCall) -> ConversationRequest {
        ...
        ConversationRequest {
            ...
            length_policy: xvora_sampling_types::LengthPolicy::Fail,
            ..Default::default()
        }
    }
