...
impl DrainSource {
    ...
    pub(super) fn into_parts(
        ...
        xvora_tools::implementations::xvora::update_goal::UpdateGoalInput,
        Option<
...
pub(super) fn try_send_ack(
    ack_tx: Option<
        ...
        >,
    >,
    ack: xvora_tools::implementations::xvora::update_goal::UpdateGoalAck,
) {
...
pub(crate) fn goal_slash_and_harness_available(goal_enabled: bool, tool_names: &[String]) -> bool {
    use xvora_tools::implementations::xvora::UPDATE_GOAL_TOOL_NAME;
...
impl SessionActor {
    ...
    pub(super) async fn set_goal_loop_active_resource(&self, active: bool) {
        ...
        self.agent
            ...
            .tool_bridge()
            .update_resource(
                xvora_tools::implementations::xvora::task::types::GoalLoopActive(active),
            )
            .await;
    }
}
