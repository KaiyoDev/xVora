...
pub(crate) async fn test_agent_with_goal_tool() -> xvora_agent::Agent {
    use xvora_tools::implementations::xvora::update_goal::UpdateGoalTool;
...
#[cfg(test)]
pub(crate) async fn test_xvora_agent_with_todo() -> xvora_agent::Agent {
    use xvora_tools::implementations::xvora::todo::TodoWriteTool;
    use xvora_tools::registry::types::ToolConfig;
...
pub(crate) async fn test_agent_with_plan_tools() -> xvora_agent::Agent {
    use xvora_tools::implementations::xvora::enter_plan_mode::EnterPlanModeTool;
    use xvora_tools::implementations::xvora::exit_plan_mode::ExitPlanModeTool;
    use xvora_tools::registry::types::ToolConfig;
