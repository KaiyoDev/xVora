...
use crate::test_support::sse::chat_completion_script_exact;
use crate::test_support::{MockInferenceServer, ScriptedResponse, SseEvent};
...
async fn salvage_test_actor_with_context(
    ...
    salvage_test_actor_on_backend(
        ...
        total_tokens,
        context_window,
        xvora_sampling_types::ApiBackend::ChatCompletions,
    )
    .await
}
...
fn error_with_tiny_window(
    ...
    xvora_sampler::SamplingErrorInfo {
        ...
        model_metadata: Some(xvora_sampling_types::ResponseModelMetadata {
