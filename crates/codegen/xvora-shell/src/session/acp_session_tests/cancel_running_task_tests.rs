    ...
    local
        .run_until(async {
            ...
            agent
                .tool_bridge()
                .update_resource(
                    xvora_tools::implementations::xvora::task::types::CurrentPromptIdResource(
                        "running".to_string(),
                    ),
                )
                .await;
    ...
    local
        .run_until(async {
            ...
            let request = ConversationRequest {
                items: vec![
                    ConversationItem::User(xvora_sampling_types::UserItem { content :
                    vec![xvora_sampling_types::ContentPart::Text { text : "hi".into(),
        ...
        actor
            ...
            .filter(|item| {
                matches!(
                    ...
                    matches!(p, xvora_sampling_types::ContentPart::Text { text } if
