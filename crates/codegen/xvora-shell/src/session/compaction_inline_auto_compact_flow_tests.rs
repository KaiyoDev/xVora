...
fn switch_target_config(model: &str, base_url: String) -> xvora_sampler::SamplerConfig {
    xvora_sampler::SamplerConfig {
    ...
    local
        .run_until(async {
            ...
            actor.chat_state_handle.replace_conversation(vec![
                ...
                ConversationItem::Reasoning(xvora_sampling_types::rs::ReasoningItem {
                ...
                ConversationItem::ToolResult(xvora_sampling_types::ToolResultItem {
...
fn user_facing_compact_error_strips_prefix_single_lines_and_caps() {
    ...
    let nested = xvora_compaction::sampler::CompactionSampleError::Build(format!(
