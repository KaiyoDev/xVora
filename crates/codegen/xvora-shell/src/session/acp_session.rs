...
pub(crate) struct SessionActor {
    ...
    /// `xvora-sampler`. Threaded into every `SamplerConfig`
    ...
    pub(crate) pending_classifier_completions: parking_lot::Mutex<
        VecDeque<xvora_tools::implementations::xvora::update_goal::UpdateGoalInput>,
    >,
    ...
    pub(crate) mcp_announced_servers:
        Mutex<HashMap<String, xvora_tools::implementations::search_tool::ServerFingerprint>>,
    ...
    /// (system prompt, [`xvora_tools::bridge::ToolBridge`], tool
