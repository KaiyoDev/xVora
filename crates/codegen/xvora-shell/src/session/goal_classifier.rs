...
pub(crate) fn build_subagent_trace_items(
    ...
    prompt: &str,
    output: &str,
) -> Vec<xvora_sampling_types::conversation::ConversationItem> {
    use xvora_sampling_types::conversation::{ConversationItem, ToolCall};
...
mod tests {
    ...
    fn verifier_template_renders_per_agent_type_and_falls_back() {
        use xvora_tools::implementations::xvora::task::types::SubagentTypeSummary;
