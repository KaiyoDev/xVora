...
///
/// In forked sessions, tools produce output containing the worktree directory (e.g., `/root/.xvora/worktrees/project/fork-019cb252-...`).
...
impl PathRewriter {
    ...
    /// and URL-encoded paths (e.g., `%2Froot%2F.xvora%2Fworktrees%2F...`) that appear in session directory structures and `output_file` references.
