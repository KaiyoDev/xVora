...
pub enum SideQuestionError {
    ...
    Sampling(#[from] xvora_sampling_types::SamplingError),
...
pub enum SessionCommand {
    ...
    GetToolOverrides {
        respond_to: oneshot::Sender<Option<xvora_sampling_types::ToolOverrides>>,
    },
    ...
    SetToolOverrides {
        overrides: xvora_sampling_types::ToolOverrides,
    },
    Prompt {
        prompt_id: String,
        ...
        tool_overrides_update: Option<xvora_sampling_types::ToolOverridesUpdate>,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<xvora_sampling_types::ToolSpec>>,
    },
