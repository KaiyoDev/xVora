...
pub enum ManagedConfigError {
    ...
    #[error(
        "Your team sign-in was rejected. It may have expired or lack access. Run `xvora login` to sign in again."
    )]
    TeamAuthRejected,
...
impl ManagedConfigResponse {
    ...
    pub(super) fn signature_sidecar(
        ...
        self.signature_sidecar_with(xvora_config::signed_policy::embedded_key_id_trusted)
    }
