...
pub(crate) struct PromptResponseMetaArgs<'a> {
    ...
    pub total_tokens: u64,
    pub model_id: &'a str,
    pub last_turn_usage: Option<&'a xvora_sampling_types::TokenUsage>,
...
pub struct MvpAgent {
    ...
    session_index_claims: RefCell<
        HashMap<acp::SessionId, std::sync::Arc<codebase_graph::IndexManagerHandle>>,
    >,
    ...
    monitor_event_buffer: xvora_tools::implementations::xvora::task::types::MonitorEventBuffer,
...
impl MvpAgent {
    ...
    fn forward_raw_replay_line(
        ...
        completions: &mut Vec<
            tokio::sync::oneshot::Receiver<acp_lib::AcpResult<()>>,
        >,
        mark_replay: bool,
