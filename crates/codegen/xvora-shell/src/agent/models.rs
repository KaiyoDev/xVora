...
impl ModelsManager {
    ...
    pub fn model_compactions_remaining(
        &self,
        model_id: &str,
    ) -> Option<xvora_sampling_types::CompactionsRemaining> {
        self.inner
            .models
            .read()
            .get(model_id)
    ...
    pub fn model_compaction_at_tokens(
        &self,
        model_id: &str,
    ) -> Option<xvora_sampling_types::CompactionAtTokens> {
        self.inner
            .models
            .read()
            .get(model_id)
...
fn resolve_prefetch_env_with_auth(auth: Option<XaiAuth>) -> Option<PrefetchEnv> {
...
pub fn start_early_prefetch_with_auth(auth: Option<XaiAuth>) -> Option<EarlyPrefetchHandle> {
...
mod tests {
    ...
    fn reasoning_effort_override_skips_models_that_do_not_offer_level() {
        use indexmap::IndexMap;
        use xvora_sampling_types::ReasoningEffortOption;
