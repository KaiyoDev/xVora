...
/// Process-wide write lock for `~/.xvora/config.toml`.
///
...
mod tests {
    ...
    fn merge_section_updates_modeled_fields_preserving_unmodeled() {
        ...
        ui.insert(
            ...
            TomlValue::String("xvoraday".into()),
        );
        table.insert("ui".into(), TomlValue::Table(ui));
...
"#;
        ...
        assert_eq!(cfg.ui.auto_light_theme.as_deref(), Some("xvoraday"));
...
"#;
    ...
    mod resolve_auto_compact {
        ...
        /// Serialize tests that mutate `XVORA_AUTO_COMPACT_THRESHOLD_PERCENT`.
    ...
    fn settings_helpers_target_correct_ui_fields() {
        ...
        let cfg = apply(|cfg| cfg.ui.auto_light_theme = Some("xvoraday".to_string()));
        assert_eq!(cfg.ui.auto_light_theme, Some("xvoraday".to_string()));
