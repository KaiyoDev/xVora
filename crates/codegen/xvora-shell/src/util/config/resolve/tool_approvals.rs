...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "XVORA_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`XVORA_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `XVORA_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
