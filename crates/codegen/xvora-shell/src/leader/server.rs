...
pub async fn run_leader_server(
    ...
    loop {
        tokio::select! {
            ...
            xvora_telemetry::unified_log::info("leader.client.registered", None,
            ...
            xvora_telemetry::unified_log::info("leader.client.disconnected", None,
            ...
            xvora_telemetry::unified_log::warn("leader.response.orphaned", None,
            ...
            xvora_telemetry::unified_log::warn("leader.response.send_failed", None,
...
mod tests {
    ...
    /// registration (devbox / `xvora agent headless` flow) flips the watch so
