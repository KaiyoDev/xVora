...
impl BackendClient {
    ...
    /// Must include X-XAI-Token-Auth so nginx auth subrequest routes to authenticate_xvora_cli_token.
    /// See: crates/codegen/xvora-shell/src/agent/app.rs:run_headless
...
pub fn parse_remote_model_value(
    ...
    Some(crate::agent::config::ModelEntryConfig {
        ...
        reasoning_efforts: obj
            ...
            .map(|arr| xvora_sampling_types::parse_reasoning_effort_options(arr))
            .unwrap_or_default(),
        ...
        compactions_remaining: obj
            ...
            .or_else(|| {
                obj
                    ...
                    .and_then(|v| v.as_bool())
                    .map(xvora_sampling_types::CompactionsRemaining::Dynamic)
            }),
...
mod tests {
    ...
    async fn fetch_subagent_bundle_success() {
        ...
        assert_eq!(headers.token_auth.as_deref(), Some("xvora-cli"));
    ...
    /// REGRESSION: `xvora setup` must send the deployment key to
