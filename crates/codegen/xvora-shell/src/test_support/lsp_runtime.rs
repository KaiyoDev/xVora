...
impl xvora_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &xvora_tools::implementations::lsp::LspToolInput,
    ) -> xvora_tools::implementations::lsp::LspToolResult {
        xvora_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<xvora_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<xvora_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
