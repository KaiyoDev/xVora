...
- **Added `xvora wrap`** to run any command with local clipboard support.
...
- **Fixed `xvora agent stdio` startup hangs** on Windows when used with persistent clients such as VS Code or grok-desktop.
