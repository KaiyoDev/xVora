...
| `X-XAI-Token-Auth: xvora-cli` | Yes      | Tells the auth middleware to validate as a CLI session token                                                                                                                              |
...
XVORA_LOG_FILE=/tmp/grok-debug.log RUST_LOG="info,xvora_shell::auth=debug" grok
```
