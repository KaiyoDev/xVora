//! Built-binary end-to-end tests for the xvora (xvora-pager) binary.
//!
...
//! ```bash
//! cargo test -p xvora-shell --test test_built_binary_e2e -- --ignored
//! ```
//!
...
use xvora_test_support::env::test_env_cmd_tokio;
...
async fn test_headless_json_reports_server_cost() {
    use xvora_test_support::scripted::SseEvent;
    ...
    server.enqueue_response(
        "/v1/chat/completions",
        xvora_test_support::scripted::ScriptedResponse::sse(vec![
...
async fn test_headless_json_reports_usage_on_max_turns() {
    ...
    server.enqueue_response(
        "/v1/chat/completions",
        xvora_test_support::scripted::ScriptedResponse::sse(
            xvora_test_support::sse::chat_completions_reasoning_then_tool_call_events(
                "let me look",
                "call-1",
                "read_file",
                r#"{"path":"README.md"}"#,
