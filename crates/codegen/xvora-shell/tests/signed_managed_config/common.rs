...
pub fn signed_team_body(
    ...
    let payload = SignedPayload {
        ...
        fail_closed: requirements.is_some_and(xvora_config::fail_closed_flag_from_str),
...
pub fn team_identity(id: &str) -> xvora_shell::config::ServingIdentity {
    xvora_shell::config::ServingIdentity::Team(id.to_owned())
}
