...
2. **Scope** - present the user with two options:
   - **Project** (Recommended): `<repo-root>/.xvora/skills/<name>/SKILL.md` - available only in this repo, shareable with teammates
   - **User**: `~/.xvora/skills/<name>/SKILL.md` - available in all projects
...
Where `<SKILL_DIR>` is:
- User scope: `~/.xvora/skills/<name>`
- Project scope: `<repo-root>/.xvora/skills/<name>`
