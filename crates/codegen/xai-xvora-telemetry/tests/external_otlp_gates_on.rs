...
use xai_xvora_telemetry::external::{self, ExternalOtelRemotePolicy, IdentityAttrs};
...
fn external_stream_gates_on_end_to_end() {
    ...
    xai_xvora_telemetry::log_event(xai_xvora_telemetry::events::ToolCallCompleted {
